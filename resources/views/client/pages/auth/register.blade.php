                ...
                <div class="col-md-8 col-lg-6 col-xl-5">
                    <div class="card">
                        <div class="card-body p-4 p-sm-5">
                            <h4 class="mb-2 text-center">Đăng ký tài khoản mới 🎉</h4>
                            <p class="mb-4 text-center">Vui lòng điền thông tin để tạo tài khoản</p>
                            ...
                            <form action="{{ route('client.auth.register') }}" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control" id="full_name" name="full_name"
                                        placeholder="Nhập họ và tên" value="{{ old('full_name') }}" required autofocus>
                                </div>
                                <div class="mb-3">
