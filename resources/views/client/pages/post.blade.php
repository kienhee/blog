            ...
            <aside class="post-sidebar">
                ...
                <div class="sidebar-widget">
                    <h3 class="sidebar-widget-title" onclick="toggleTOC()">
                        ...
                        <button class="sidebar-widget-toggle collapsed" type="button" aria-label="Đóng/Mở mục lục">
                    ...
                    <div class="sidebar-widget ">
                        ...
                        <ul class="list-unstyled d-flex flex-wrap gap-2">
                            @foreach ($allHashtags->take(10) as $hashtag)
                                <li>
                                    <a href="" class="badge rounded-pill bg-label-secondary">
                ...
                <div class="sidebar-widget newsletter-widget">
                    <div class="newsletter-brand">
                        ...
                        <h3 class="newsletter-title">Nhận tin tức</h3>
                    </div>
                    <p class="newsletter-description">
                        Đăng ký để nhận thông báo về các bài viết mới nhất. Những bài viết thực tế và hữu ích về công nghệ,
                        lập trình và phát triển sự nghiệp.
                    </p>
                    <form class="newsletter-form" id="newsletter-form">
                        @csrf
                        <div class="newsletter-form-group">
                            <input type="email" class="newsletter-email" id="newsletter-email" name="email"
