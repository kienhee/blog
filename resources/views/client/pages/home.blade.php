    ...
    <div data-bs-spy="scroll" class="scrollspy-example">
            ...
            <div id="landingHero" class="section-py landing-hero position-relative">
                ...
                <div class="container">
                    <div class="hero-text-box text-center">
                        <h1 class="text-primary hero-title display-4 fw-bold">One dashboard to manage all your
                            businesses</h1>
                        ...
                        <div class="landing-hero-btn d-inline-block position-relative">
                            <span class="hero-btn-item position-absolute d-none d-md-flex text-heading">Join community
                                <img src="{{ asset_admin_url('assets/img/front-pages/icons/Join-community-arrow.png') }}"
                    ...
                    <div id="heroDashboardAnimation" class="hero-animation-img">
                        <a href="../vertical-menu-template/app-ecommerce-dashboard.html" target="_blank">
                            <div id="heroAnimationImg" class="position-relative hero-dashboard-img">
                                <img src="{{ asset_admin_url('assets/img/front-pages/landing-page/hero-dashboard-light.png') }}"
                                    alt="hero dashboard" class="animation-img"
                                    data-app-light-img="front-pages/landing-page/hero-dashboard-light.png"
                                    data-app-dark-img="front-pages/landing-page/hero-dashboard-dark.png" />
                                <img src="{{ asset_admin_url('assets/img/front-pages/landing-page/hero-elements-light.png') }}"
                                    alt="hero elements"
        ...
        <section id="landingFeatures" class="section-py landing-features">
            <div class="container">
                ...
                <h3 class="text-center mb-1">Everything you need to start your next project</h3>
                ...
                <div class="features-icon-wrapper row gx-0 gy-4 g-sm-5">
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-3">
                            <img src="{{ asset_admin_url('assets/img/front-pages/icons/laptop.png') }}"
                                alt="laptop charging" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-3">
                            <img src="{{ asset_admin_url('assets/img/front-pages/icons/rocket.png') }}"
                                alt="transition up" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-3">
                            <img src="{{ asset_admin_url('assets/img/front-pages/icons/paper.png') }}" alt="edit" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-3">
                            <img src="{{ asset_admin_url('assets/img/front-pages/icons/check.png') }}"
                                alt="3d select solid" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-3">
                            <img src="{{ asset_admin_url('assets/img/front-pages/icons/user.png') }}" alt="lifebelt" />
                        </div>
                    ...
                    <div class="col-lg-4 col-sm-6 text-center features-icon-box">
                        <div class="text-center mb-3">
                            <img src="{{ asset_admin_url('assets/img/front-pages/icons/keyboard.png') }}"
                                alt="google docs" />
                        </div>
            ...
            <div class="container">
                <div class="row align-items-center gx-0 gy-4 g-lg-5">
                    <div class="col-md-6 col-lg-5 col-xl-3">
                        ...
                        <h3 class="mb-1">What people say</h3>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                ...
                                                <div class="mb-3">
                                                    <img src="{{ asset_admin_url('assets/img/front-pages/branding/logo-1.png') }}"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-2 avatar-sm">
                                                        <img src="{{ asset_admin_url('assets/img/avatars/1.png') }}"
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                <div class="mb-3">
                                                    <img src="{{ asset_admin_url('assets/img/front-pages/branding/logo-2.png') }}"
                                                        alt="client logo" class="client-logo img-fluid" />
                                                </div>
                                                <p>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-2 avatar-sm">
                                                        <img src="{{ asset_admin_url('assets/img/avatars/2.png') }}"
                                                            alt="Avatar" class="rounded-circle" />
                                                    </div>
                                                    <div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                <div class="mb-3">
                                                    <img src="{{ asset_admin_url('assets/img/front-pages/branding/logo-3.png') }}"
                                                        alt="client logo" class="client-logo img-fluid" />
                                                </div>
                                                <p>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-2 avatar-sm">
                                                        <img src="{{ asset_admin_url('assets/img/avatars/3.png') }}"
                                                            alt="Avatar" class="rounded-circle" />
                                                    </div>
                                                    <div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                <div class="mb-3">
                                                    <img src="{{ asset_admin_url('assets/img/front-pages/branding/logo-4.png') }}"
                                                        alt="client logo" class="client-logo img-fluid" />
                                                </div>
                                                <p>
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-2 avatar-sm">
                                                        <img src="{{ asset_admin_url('assets/img/avatars/4.png') }}"
                                                            alt="Avatar" class="rounded-circle" />
                                                    </div>
                                                    <div>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                <div class="mb-3">
                                                    <img src="{{ asset_admin_url('assets/img/front-pages/branding/logo-5.png') }}"
                                                        alt="client logo" class="client-logo img-fluid" />
                                                </div>
                                                <p>
                                                    “I've never used a theme as versatile and flexible as Vuexy. It's my
                                                ...
                                                <div class="d-flex align-items-center">
                                                    <div class="avatar me-2 avatar-sm">
                                                        <img src="{{ asset_admin_url('assets/img/avatars/5.png') }}"
                                                            alt="Avatar" class="rounded-circle" />
                                                    </div>
                                                    <div>
                                                        <h6 class="mb-0">Eugenia Moore</h6>
                                    ...
                                    <div class="swiper-slide">
                                        <div class="card h-100">
                                            <div
                                                class="card-body text-body d-flex flex-column justify-content-between h-100">
                                                <div class="mb-3">
                                                    <img src="{{ asset_admin_url('assets/img/front-pages/branding/logo-6.png') }}"
                                                        alt="client logo" class="client-logo img-fluid" />
                                                </div>
                                                <p>
            ...
            <div class="container">
                <div class="swiper-logo-carousel py-4 my-lg-2">
                    <div class="swiper" id="swiper-clients-logos">
                        <div class="swiper-wrapper">
                            <div class="swiper-slide">
                                <img src="{{ asset_admin_url('assets/img/front-pages/branding/logo_1-light.png') }}"
        ...
        <section id="landingTeam" class="section-py landing-team">
            <div class="container">
                ...
                <h3 class="text-center mb-1">Supported by Real People</h3>
                <p class="text-center mb-md-5 pb-3">Who is behind these great-looking interfaces?</p>
                <div class="row gy-5 mt-2">
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div class="bg-label-primary position-relative team-image-box">
                                <img src="{{ asset_admin_url('assets/img/front-pages/landing-page/team-member-1.png') }}"
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div class="bg-label-info position-relative team-image-box">
                                <img src="{{ asset_admin_url('assets/img/front-pages/landing-page/team-member-2.png') }}"
                                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                                    alt="human image" />
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div class="bg-label-danger position-relative team-image-box">
                                <img src="{{ asset_admin_url('assets/img/front-pages/landing-page/team-member-3.png') }}"
                                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                                    alt="human image" />
                            </div>
                    ...
                    <div class="col-lg-3 col-sm-6">
                        <div class="card mt-3 mt-lg-0 shadow-none">
                            <div class="bg-label-success position-relative team-image-box">
                                <img src="{{ asset_admin_url('assets/img/front-pages/landing-page/team-member-4.png') }}"
                                    class="position-absolute card-img-position bottom-0 start-50 scaleX-n1-rtl"
                                    alt="human image" />
                            </div>
                ...
                <div class="text-center mb-5">
                    <div class="position-relative d-inline-block pt-3 pt-md-0">
                        ...
                        <div class="pricing-plans-item position-absolute d-flex">
                            <img src="{{ asset_admin_url('assets/img/front-pages/icons/pricing-plans-arrow.png') }}"
                ...
                <div class="row gy-4 pt-lg-3">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <div class="text-center">
                                    <img src="{{ asset_admin_url('assets/img/front-pages/icons/paper-airplane.png') }}"
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="card border border-primary shadow-lg">
                            <div class="card-header">
                                <div class="text-center">
                                    <img src="{{ asset_admin_url('assets/img/front-pages/icons/plane.png') }}"
                    ...
                    <div class="col-xl-4 col-lg-6">
                        <div class="card">
                            <div class="card-header">
                                <div class="text-center">
                                    <img src="{{ asset_admin_url('assets/img/front-pages/icons/shuttle-rocket.png') }}"
                ...
                <div class="row gy-3">
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-label-success shadow-none">
                            <div class="card-body text-center">
                                <img src="{{ asset_admin_url('assets/img/front-pages/icons/user-success.png') }}"
                                    alt="laptop" class="mb-2" />
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-label-info shadow-none">
                            <div class="card-body text-center">
                                <img src="{{ asset_admin_url('assets/img/front-pages/icons/diamond-info.png') }}"
                                    alt="laptop" class="mb-2" />
                    ...
                    <div class="col-sm-6 col-lg-3">
                        <div class="card border border-label-warning shadow-none">
                            <div class="card-body text-center">
                                <img src="{{ asset_admin_url('assets/img/front-pages/icons/check-warning.png') }}"
                                    alt="laptop" class="mb-2" />
        ...
        <section id="landingFAQ" class="section-py bg-body landing-faq">
            <div class="container">
                ...
                <div class="row gy-5">
                    <div class="col-lg-5">
                        <div class="text-center">
                            <img src="{{ asset_admin_url('assets/img/front-pages/landing-page/faq-boy-with-logos.png') }}"
