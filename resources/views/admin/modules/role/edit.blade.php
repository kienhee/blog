...
@section('content')
    <section>
        <form id="form_role" action="{{ route('admin.roles.update', $role->id) }}" method="POST">
            @csrf
            @method('PUT')
            @include('admin.components.headingPage', [
                'description' => 'Chỉnh sửa thông tin vai trò hệ thống',
                'button' => 'edit',
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <input type="text" id="name" name="name" class="form-control"
                                    value="{{ old('name', $role->name) }}" placeholder="Nhập tên vai trò" required
                                    maxlength="255">
                                @error('name')
