                        ...
                        <div class="col-lg-4">
                            <div class="border rounded p-3 h-100">
                                ...
                                <div class="d-flex gap-2">
                                    <button type="button" class="btn btn-sm btn-outline-primary upload_btn flex-grow-1"
                            ...
                            <div class="row g-3">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="email" id="email" class="form-control @error('email') is-invalid @enderror"
                                        value="{{ old('email', $user->email) }}" disabled maxlength="254">
                                    {{-- Hidden input để submit email khi disabled --}}
                                    <input type="hidden" name="email" value="{{ $user->email }}">
                                    <small class="text-success d-block mt-1">
                                        <i class="bx bx-info-circle"></i> Email không thể thay đổi
                                    </small>
                                    @error('email')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="phone" id="phone"
                                        ...
                                        value="{{ old('phone', $user->phone) }}" required minlength="10" maxlength="10">
                                    @error('phone')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="col-md-6">
                                    <label class="form-label" for="birthday">Ngày sinh <span
                                            class="text-danger">*</span></label>
                                    <input type="text" name="birthday" id="birthday"
                                        class="form-control date-picker @error('birthday') is-invalid @enderror"
                                        placeholder="dd/mm/yyyy" value="{{ old('birthday', $user->birthday) }}" required>
                                    @error('birthday')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
