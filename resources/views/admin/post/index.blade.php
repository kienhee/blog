...
@section('content')
    ...
    <div class="card">
        <x-alert />
        <x-header-table tableName="Tất cả bài viết" link="dashboard.post.add" linkName="Thêm mới bài viết " />
            ...
            <div class="row ">
                <div class="col-md-6 col-lg-3 mb-2">
                    <div class="input-group input-group-merge">
                        ...
                        <input type="search" class="form-control" placeholder="Tìm kiếm tên bài viết" name="keywords"
            ...
            <table class="table">
                <thead>
                    <tr>
                        ...
                        <th class="px-1 text-center" style="width: 130px">Cho phép bình luận</th>
                    ...
                    @if ($posts->count() > 0)
                        @foreach ($posts as $item)
                            <tr>
                                ...
                                <td class="px-0 text-center"><span
                                        class="badge  me-1 {{ $item->isComment == true ? 'bg-label-success ' : ' bg-label-primary' }}">{{ $item->deleted_at == true ? 'Cho phép' : 'Ẩn' }}</span>
                                </td>
