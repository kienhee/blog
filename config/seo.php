...
return [
     ...
     */
    'favicon' => '/resources/shared/images/favicon.png',
    ...
    'title' => [
         ...
         */
        'homepage_title' => config('app.name') . ' - Blog chia sẻ kiến thức về lập trình, công nghệ và cuộc sống',
    ],
    ...
    'description' => [
         ...
         */
        'fallback' => 'Blog chia sẻ kiến thức về lập trình, công nghệ và cuộc sống',
    ],
    ...
    'twitter' => [
         ...
         */
        '@username' => null, // Set your Twitter username here, e.g., 'yourusername'
    ],
];
